      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-red-hat-display mb-4">Explore roles at ITRIX's offices around the world</h2>
              ...
              <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6">
                ...
                <a className="block group" href="#0">
                  <div className="relative h-0 pb-9/16 sm:pb-1/1">
                    <Image className="absolute inset-0 w-full h-full object-cover" src={CareerImage01} width={240} height={240} alt="Career 01" />
                ...
                <a className="block group" href="#0">
                  <div className="relative h-0 pb-9/16 sm:pb-1/1">
                    <Image className="absolute inset-0 w-full h-full object-cover" src={CareerImage02} width={240} height={240} alt="Career 02" />
                    <div className="absolute inset-0 opacity-75 bg-gradient-to-t from-gray-900" aria-hidden="true"></div>
                    <div className="absolute bottom-0 left-0 right-0 m-4 text-center text-white">
                ...
                <a className="block group" href="#0">
                  <div className="relative h-0 pb-9/16 sm:pb-1/1">
                    <Image className="absolute inset-0 w-full h-full object-cover" src={CareerImage03} width={240} height={240} alt="Career 03" />
                    <div className="absolute inset-0 opacity-75 bg-gradient-to-t from-gray-900" aria-hidden="true"></div>
                    <div className="absolute bottom-0 left-0 right-0 m-4 text-center text-white">
                ...
                <a className="block group" href="#0">
                  <div className="relative h-0 pb-9/16 sm:pb-1/1">
                    <Image className="absolute inset-0 w-full h-full object-cover" src={CareerImage04} width={240} height={240} alt="Career 04" />
                    <div className="absolute inset-0 opacity-75 bg-gradient-to-t from-gray-900" aria-hidden="true"></div>
                    <div className="absolute bottom-0 left-0 right-0 m-4 text-center text-white">
                ...
                <a className="block group" href="#0">
                  <div className="relative h-0 pb-9/16 sm:pb-1/1">
                    <Image className="absolute inset-0 w-full h-full object-cover" src={CareerImage05} width={240} height={240} alt="Career 05" />
                    <div className="absolute inset-0 opacity-75 bg-gradient-to-t from-gray-900" aria-hidden="true"></div>
                    <div className="absolute bottom-0 left-0 right-0 m-4 text-center text-white">
                ...
                <a className="block group" href="#0">
                  <div className="relative h-0 pb-9/16 sm:pb-1/1">
                    <Image className="absolute inset-0 w-full h-full object-cover" src={CareerImage06} width={240} height={240} alt="Career 06" />
                    <div className="absolute inset-0 opacity-75 bg-gradient-to-t from-gray-900" aria-hidden="true"></div>
                    <div className="absolute bottom-0 left-0 right-0 m-4 text-center text-white">
