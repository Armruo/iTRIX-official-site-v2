          ...
          <div className="overflow-x-auto">
            <table className="table-auto w-full dark:text-gray-300">
              ...
              <tbody className="text-sm divide-y divide-gray-100 dark:divide-gray-700/60">
                ...
                <tr>
                  <td className="py-2">
                    <div className="text-left">preview.itrix.com/open-pro/</div>
                  </td>
                  <td className="py-2">
                ...
                <tr>
                  <td className="py-2">
                    <div className="text-left">preview.itrix.com/simple/</div>
                  </td>
                  <td className="py-2">
                ...
                <tr>
                  <td className="py-2">
                    <div className="text-left">itrix.com/unlimited/</div>
                  </td>
                  <td className="py-2">
                ...
                <tr>
                  <td className="py-2">
                    <div className="text-left">preview.itrix.com/twist/</div>
                  </td>
                  <td className="py-2">
