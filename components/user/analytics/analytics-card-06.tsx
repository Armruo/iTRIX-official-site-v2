          ...
          <div className="grow">
            ...
            <ul className="space-y-1 text-sm text-gray-800 dark:text-gray-100 mt-3 mb-4">
              ...
              <li className="relative px-2 py-1">
                ...
                <div className="relative flex justify-between space-x-2">
                  <div>preview.itrix.com/open-pro/</div>
              ...
              <li className="relative px-2 py-1">
                ...
                <div className="relative flex justify-between space-x-2">
                  <div>preview.itrix.com/appy/</div>
              ...
              <li className="relative px-2 py-1">
                ...
                <div className="relative flex justify-between space-x-2">
                  <div>preview.itrix.com/simple/</div>
              ...
              <li className="relative px-2 py-1">
                ...
                <div className="relative flex justify-between space-x-2">
                  <div>preview.itrix.com/twist/</div>
