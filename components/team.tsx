...
import TeamImage01 from '@/public/images/user/team-member-01.jpg'
import TeamImage02 from '@/public/images/user/team-member-02.jpg'
import TeamImage03 from '@/public/images/user/team-member-03.jpg'
import TeamImage04 from '@/public/images/user/team-member-04.jpg'
import TeamImage05 from '@/public/images/user/team-member-05.jpg'
import TeamImage06 from '@/public/images/user/team-member-06.jpg'
import TeamImage07 from '@/public/images/user/team-member-07.jpg'
import TeamImage08 from '@/public/images/user/team-member-08.jpg'
import TeamImage09 from '@/public/images/user/team-member-09.jpg'
import TeamImage10 from '@/public/images/user/team-member-10.jpg'
          ...
          <div className="max-w-xs sm:max-w-lg md:max-w-3xl lg:max-w-5xl mx-auto">
            <div className="flex flex-wrap justify-center -m-5 lg:-my-7" data-aos-id-team>
              ...
              <div className="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-5 lg:py-7" data-aos="fade-down" data-aos-delay="400" data-aos-anchor="[data-aos-id-team]">
                <div className="flex flex-col items-center">
                  <Image className="rounded-full mb-2" src={TeamImage05} width={80} height={80} alt="Team member 05" />
              ...
              <div className="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-5 lg:py-7" data-aos="fade-down" data-aos-delay="500" data-aos-anchor="[data-aos-id-team]">
                <div className="flex flex-col items-center">
                  <Image className="rounded-full mb-2" src={TeamImage06} width={80} height={80} alt="Team member 06" />
              ...
              <div className="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-5 lg:py-7" data-aos="fade-down" data-aos-delay="600" data-aos-anchor="[data-aos-id-team]">
                <div className="flex flex-col items-center">
                  <Image className="rounded-full mb-2" src={TeamImage07} width={80} height={80} alt="Team member 07" />
              ...
              <div className="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-5 lg:py-7" data-aos="fade-down" data-aos-delay="700" data-aos-anchor="[data-aos-id-team]">
                <div className="flex flex-col items-center">
                  <Image className="rounded-full mb-2" src={TeamImage08} width={80} height={80} alt="Team member 08" />
              ...
              <div className="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-5 lg:py-7" data-aos="fade-down" data-aos-delay="600" data-aos-anchor="[data-aos-id-team]">
                <div className="flex flex-col items-center">
                  <Image className="rounded-full mb-2" src={TeamImage09} width={80} height={80} alt="Team member 09" />
              ...
              <div className="w-1/2 sm:w-1/3 md:w-1/4 lg:w-1/5 p-5 lg:py-7" data-aos="fade-down" data-aos-delay="700" data-aos-anchor="[data-aos-id-team]">
                <div className="flex flex-col items-center">
                  <Image className="rounded-full mb-2" src={TeamImage10} width={80} height={80} alt="Team member 10" />
