...
import Feedback from '@/components/ui/docs/feedback'
import PageNavigation from '@/components/ui/docs/page-navigation'
import Footer from '@/components/ui/footer'
import SecondaryNav from '@/components/ui/docs/secondary-nav'

export async function generateStaticParams() {
  return allDocs.map((doc) => ({
    topic: doc.topic.slug,
    slug: doc.slug,
  }))
}
...
export async function generateMetadata({ params }: {
  ...
  const doc = allDocs.find((doc) => doc.topic.slug === params.topic && doc.slug === params.slug)
