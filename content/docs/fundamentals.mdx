...
summary: "This guide will give you need to start using the Docs Marketing API to manage audiences, control automation workflows, sync email activity with your database, and more."
topic: {
  name: "Fundamentals",
  slug: "fundamentals"
}
